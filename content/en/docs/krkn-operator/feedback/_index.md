...
<p><strong>JavaScript is required to submit this form.</strong> Please enable JavaScript in your browser, or <a href="https://github.com/krkn-chaos/krkn-operator/issues">open an issue on GitHub</a> instead.</p>
</div>
</noscript>
...
<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="color: #22c55e; margin-bottom: 1rem;">
